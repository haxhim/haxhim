...
- 🎓 Diploma in Digital Technology at **Politeknik Ungku Omar**  
- 💻 Founder of **Haxion Labs** — delivering web development, HR systems, company portfolios, and membership management solutions  
- 🛠 Currently developing **HaxCombat** — a SaaS tool for sports clubs with transaction-based payments  
- 🤖 Passionate about **AI**, **IoT**, **SaaS**, and **digital product development**  
- 🌱 Continuously learning **Python, HTML, CSS, JavaScript, and AI integration**  
- 💡 Interested in starting **service-based, digital product, and e-commerce businesses**  
...
- **Frameworks & Tools:** Bootstrap, TailwindCSS, LiveKit, AI APIs  
- **Development:** Web apps, SaaS platforms, responsive UI/UX  
- **IoT Projects:** ESP32, LilyGO T-Display, sensor integrations  
- **Business & Management:** Freelance project management, startup building, SaaS product strategy  
...
- Always aiming to **learn new skills**  and grow
- Combining **tech skills and entrepreneurship** to make impactful projects  
- Focused on living a **disciplined, Islamic lifestyle** while staying **healthy and productive**  
...
- 👀 Following me for updates on new projects  
- 📨 Reaching out for collaborations or freelance opportunities  
